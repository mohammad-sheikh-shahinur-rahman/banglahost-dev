...
{
    /// <summary>Root data dir, overridable via the BANGLAHOST_HOME env var (mirrors the mac engine).</summary>
    public static string Home =>
        Environment.GetEnvironmentVariable("BANGLAHOST_HOME") is { Length: > 0 } h
            ? h
            : System.IO.Path.Combine(LocalAppData(), "BanglaHost");
    ...
    private static string LocalAppData()
    {
        ...
        return string.IsNullOrWhiteSpace(known) ? System.IO.Path.Combine("C:\\", "BanglaHost-data") : known;
    }
