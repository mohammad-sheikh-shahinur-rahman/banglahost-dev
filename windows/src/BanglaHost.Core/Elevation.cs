...
/// <summary>
/// Bridges the unprivileged CLI/GUI to <c>banglahost-elevate.exe</c> for the few
...
{
    /// <summary>Locate banglahost-elevate.exe (next to the running exe, or the published layout).</summary>
    public static string? HelperPath()
    {
        var dir = AppContext.BaseDirectory;
        foreach (var name in new[] { "banglahost-elevate.exe", "BanglaHost.Elevate.exe" })
        {
