...
public static class Downloader
{
    ...
    private const string UA = "BanglaHost/0.1 (+https://github.com/mohammad-sheikh-shahinur-rahman/BanglaHost)";
    ...
    /// installer/UAC. Download with curl's DEFAULT UA (no custom BanglaHost UA → avoids any CDN 403).</summary>
    ...
    /// We fetch the NON-thread-safe (nonts) bundle because BanglaHost's php-cgi builds are NTS — its
    ...
    static Downloader()
    {
        Http.DefaultRequestHeaders.UserAgent.ParseAdd("BanglaHost/0.1 (+https://github.com/mohammad-sheikh-shahinur-rahman/BanglaHost)");
    }
}
