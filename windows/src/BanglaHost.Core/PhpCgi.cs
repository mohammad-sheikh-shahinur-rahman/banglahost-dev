...
public static class PhpCgi
{
    ...
    /// <summary>BanglaHost-managed extra-ini dir for a version (ionCube etc.), loaded via PHP_INI_SCAN_DIR.</summary>
    ...
    /// <summary>Apply BanglaHost's limits + performance directives to a build's php.ini (active or
