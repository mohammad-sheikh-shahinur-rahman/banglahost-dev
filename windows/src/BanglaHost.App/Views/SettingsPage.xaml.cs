...
public sealed partial class SettingsPage : Page
{
    ...
    public SettingsPage()
    {
        ...
        // About-card logo (unpackaged app → load from the app folder).
        var logo = System.IO.Path.Combine(AppContext.BaseDirectory, "Assets", "Logo.png");
        if (System.IO.File.Exists(logo))
            try { LogoImg.Source = new Microsoft.UI.Xaml.Media.Imaging.BitmapImage(new Uri(logo)); } catch { }
    }
    ...
    private async void CheckUpdates_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Title = $"BanglaHost {r.Latest} available",
